...
- Firebase Authentication
  ...
  - Phone: 已启用
  - Google: 已启用
  - Apple: 待 Apple Developer Service ID / Team ID / Key ID / Private Key
...
- Apple 登录需要在 Apple Developer 和 Firebase Console 完成 Sign in with Apple 配置，redirect URL 为 `https://random-match-7370c.firebaseapp.com/__/auth/handler`。
